"""Regression checks for the notion-plat-mesh-pipe casebook."""
...
from casebook.harness import assert_expected, notion_plat_mesh_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_plat_mesh_pipe_summary(), assert_expected())
